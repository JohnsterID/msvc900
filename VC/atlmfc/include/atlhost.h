...
// IDocHostUIHandler
	...
	STDMETHOD(GetOptionKeyPath)(_Deref_out_z_ LPOLESTR* pchKey, DWORD dwReserved)
	{
		HRESULT hr = S_FALSE;
		if (pchKey == NULL)
		{
	...
	STDMETHOD(TranslateUrl)(DWORD dwTranslate, _In_z_ OLECHAR* pchURLIn, _Deref_out_z_ OLECHAR** ppchURLOut)
	{
