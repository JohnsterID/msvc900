...
inline BOOL Canonicalize( _Out_ char* pszDest, _In_ const char* pszSrc )
{
	return ::PathCanonicalizeA( pszDest, pszSrc );
}

inline BOOL Canonicalize( _Out_ wchar_t* pszDest, _In_ const wchar_t* pszSrc )
{
	return ::PathCanonicalizeW( pszDest, pszSrc );
}

inline char* Combine( _Out_ char* pszDest, _In_ const char* pszDir,
	_In_ const char* pszFile )
{
	return ::PathCombineA( pszDest, pszDir, pszFile );
}

inline wchar_t* Combine( _Out_ wchar_t* pszDest, _In_ const wchar_t* pszDir,
...
inline BOOL RelativePathTo( _Out_ char* pszPath, _In_ const char* pszFrom,
...
inline BOOL RelativePathTo( _Out_ wchar_t* pszPath, _In_ const wchar_t* pszFrom,
